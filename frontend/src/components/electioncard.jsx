      ...
      <div className="bg-black w-full min-h-screen gap-4 flex-wrap flex justify-center items-center">
        {elections.length === 0 ? (
          <div className='flex flex-col justify-center items-center h-screen'>
              <h2 className='text-center text-5xl font-extrabold text-red-500 '>No Elections</h2>
              <blockquote className='text-center text-gray-200 mt-30'>Come Back Later!  Let's go back </blockquote>
          ...
          elections.map((election, index) => (
            <div
              key={index}
              className="w-45 p-2 bg-red-600 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl"
            >
              <img
